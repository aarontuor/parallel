...
config var n: int = 2**3;      // the size of the array to be sorted
config var thresh: int = 1;     // the recursive depth to serialize
config var verbos: int = 0;    // print out this many elements in array
...
//
// print out front of array if verbos flag is set
//
if verbos > 0 then
  writeln("A[1..", verbos, "] = ", A[1..verbos]);
